...
public:
  ...
  void visit_assign_expr(AssignExpr *assign_expr) {
    std::cout << assign_expr->identifier.lexeme << " "
  ...
  void visit_primary(Primary *primary) { std::cout << primary->value.lexeme; }
  ...
  void visit_break_stmt(BreakStmt *break_stmt) { std::cout << "break"; }
  ...
  void visit_type_stmt(TypeStmt *type_stmt) {
    std::cout << "type " << type_stmt->identifier.lexeme << " = "
              << type_stmt->type_token->get_token().lexeme;
  }
  ...
  visit_struct_initialization(StructInitialization *struct_initialization) {
    ...
    for (auto it = struct_initialization->field_assignments.begin();
         it != struct_initialization->field_assignments.end(); it++) {
      std::cout << it->first << ": ";
