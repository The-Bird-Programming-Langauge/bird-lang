...
void CodeGen::init_std_lib() {
  ...
  BinaryenAddFunctionImport(this->mod, "print_char", "env", "print_char", BinaryenTypeInt32(), BinaryenTypeNone());
  ...
  BinaryenAddFunctionImport(this->mod, "str_to_array", "env", "str_to_array",
